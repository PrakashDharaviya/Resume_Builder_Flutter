...
class ActiveTemplatesPage extends StatefulWidget {
  const ActiveTemplatesPage({super.key});

  @override
  State<ActiveTemplatesPage> createState() => _ActiveTemplatesPageState();
}

class _ActiveTemplatesPageState extends State<ActiveTemplatesPage> {
  @override
  void initState() {
    super.initState();
    context.read<AdminBloc>().add(const FetchTemplates());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<AdminBloc, AdminState>(
        buildWhen: (_, current) =>
            current is AdminTemplatesLoaded ||
        ...
        builder: (context, state) {
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  ElevatedButton(
                    onPressed: () => context.read<AdminBloc>().add(const FetchTemplates()),
          ...
          if (state is AdminTemplatesLoaded) {
