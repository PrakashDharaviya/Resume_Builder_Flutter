...
class MockDatabaseService {
  ...
  AdminRemoteDataSource get adminSource => di.sl<AdminRemoteDataSource>();
  ResumeRemoteDataSource get resumeSource => di.sl<ResumeRemoteDataSource>();
  ...
  Future<User> toggleUserPremium(String uid) =>
      adminSource.togglePremiumUser(uid);
  ...
  Future<List<Announcement>> getAnnouncements() =>
      adminSource.getAllAnnouncements();
  Future<List<Announcement>> getActiveAnnouncements() async =>
      (await adminSource.getAllAnnouncements())
          .where((a) => a.isActive)
          .toList();
